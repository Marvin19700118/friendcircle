...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onGoogleLogin, onNavigateRegister }) => {
      ...
      <div className="flex flex-col px-6 pb-6 w-full">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-[#111418] dark:text-white text-base font-medium leading-normal tracking-[0.015em] w-full hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
          >
            <span className="mr-2 flex items-center">
